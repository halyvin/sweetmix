...
<div class="info__text_wrap"><h2 class="title">Заголовочек</h2>Данный интернет проект нацелен на то, что <b>каждый клиент может создать</b> свой индивидуальный продукт, который не только удовлетворяет его желания, но при этом готовиться на натуральных составляющих. Или другой текст, описывающий исключительность ваших продуктов и сайта.</div><div class="info__text_wrap"><h2 class="title">Заголовок</h2>Данный интернет проект нацелен на то, что каждый клиент может создать свой индивидуальный продукт, который не только удовлетворяет его желания, но при этом готовиться на натуральных составляющих. Или другой текст, описывающий исключительность ваших продуктов и сайта.</div><div class="info__text_wrap"><h2 class="title">Текс</h2>Данный интернет проект нацелен на то, что каждый клиент может создать свой индивидуальный продукт, который не только удовлетворяет его желания, но при этом готовиться на натуральных составляющих. Или другой текст, описывающий исключительность ваших продуктов и сайта.</div>
EOS
