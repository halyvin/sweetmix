...
(function($)
{
	...
	Redactor.fn = $.Redactor.prototype = {
		...
		exec: function(cmd, param, sync)
		{
			...
			{
				if (cmd === 'inserthtml') { this.insertHtmlAdvanced(param, false); }
		...
		insertHtml: function (html, sync)
		{
			...
			if ($html.contents().length > 1 && currBlock && false
					|| $html.contents().is('p, :header, ul, ol, div, table, blockquote, pre, address, section, header, footer, aside, article') && false)
			{
